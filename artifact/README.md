...
system design and how to verify its public result contracts.
...
- [`CORRECTNESS.md`](CORRECTNESS.md): deterministic smoke and contract tests.
- [`datasets/`](datasets/): dataset provenance and draft archive metadata.

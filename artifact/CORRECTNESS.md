...
Source-level contract tests cover additional invariants:
...
CSR tests require generated temporary manifests and can be run separately with
`test_eggpu_bulk_csr.py`.

...
from easygraph.utils.gpu_runtime import gpu_strict_errors


__all__ = ["effective_size", "efficiency", "constraint", "hierarchy"]


def _structural_holes_gpu_runtime_dispatch(metric, G, nodes=None, weight=None):
...
def effective_size(G, nodes=None, weight=None, n_workers=None):
    ...
    """
    gpu_result = _structural_holes_gpu_runtime_dispatch(
        "effective_size", G, nodes=nodes, weight=weight
    )
...
def efficiency(G, nodes=None, weight=None, n_workers=None):
    ...
    """
    gpu_result = _structural_holes_gpu_runtime_dispatch(
        "efficiency", G, nodes=nodes, weight=weight
    )
    if gpu_result is not None:
        return gpu_result
    ...
    efficiency = {
        n: (float("nan") if degree[n] == 0 else v / degree[n])
        for n, v in e_size.items()
    }
    return efficiency
...
def constraint(G, nodes=None, weight=None, n_workers=None):
    ...
    """
    gpu_result = _structural_holes_gpu_runtime_dispatch(
        "constraint", G, nodes=nodes, weight=weight
    )
    if gpu_result is not None:
        return gpu_result
...
def hierarchy(G, nodes=None, weight=None, n_workers=None):
    ...
    """
    gpu_result = _structural_holes_gpu_runtime_dispatch(
        "hierarchy", G, nodes=nodes, weight=weight
    )
    if gpu_result is not None:
        return gpu_result

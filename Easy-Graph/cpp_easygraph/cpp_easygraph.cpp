...
PYBIND11_MODULE(cpp_easygraph, m) {
    ...
    m.def("cpp_cpu_k_core", &cpu_core_decomposition, py::arg("G"));
    m.def("cpp_gpu_k_core", &gpu_core_decomposition, py::arg("G"));
    ...
    m.def("cpp_gpu_pagerank", &_pagerank_gpu_native, py::arg("G"), py::arg("alpha") = 0.85, py::arg("max_iterator") = 200, py::arg("threshold") = 1e-6, py::arg("weight") = py::none());
    m.def("cpp_gpu_pagerank_dense", &_pagerank_gpu_native_dense, py::arg("G"), py::arg("alpha") = 0.85, py::arg("max_iterator") = 200, py::arg("threshold") = 1e-6, py::arg("weight") = py::none());
    m.def("cpp_dijkstra_multisource", &_dijkstra_multisource, py::arg("G"), py::arg("sources"), py::arg("weight") = "weight", py::arg("target") = py::none());    
    m.def("cpp_gpu_dijkstra_multisource_dense", &_dijkstra_multisource_gpu_dense, py::arg("G"), py::arg("sources"), py::arg("weight") = "weight", py::arg("target") = py::none());
    m.def("cpp_gpu_bellman_ford_multisource_dense", &_bellman_ford_multisource_gpu_dense, py::arg("G"), py::arg("sources"), py::arg("weight") = "weight", py::arg("target") = py::none());
    ...
    m.def("cpp_gpu_clustering", &_clustering_gpu_native, py::arg("G"));
    m.def("cpp_gpu_clustering_dense", &_clustering_gpu_native_dense, py::arg("G"));
    ...
    m.def("cpp_gpu_mst_edges", &_mst_gpu_native, py::arg("G"), py::arg("weight") = "weight");
    m.def("cpp_gpu_mst_index_edges", &_mst_gpu_native_index_edges, py::arg("G"), py::arg("weight") = "weight");
    m.def("cpp_gpu_mst_tree", &_mst_gpu_native_tree, py::arg("G"), py::arg("weight") = "weight");
    ...
    m.def("cpp_gpu_connected_component_labels", &_connected_components_gpu_native, py::arg("G"), py::arg("directed") = false);
